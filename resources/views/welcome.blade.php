<x-jet-app2>
    <head>
        ...
        <link href="{{ asset('img/touch-icon.png') }}" rel="apple-touch-icon">
    ...
    <!-- ======= Mobile nav toggle button ======= -->
        ...
        <section id="hero" class="d-flex flex-column justify-content-center">
            <div class="container" data-aos="zoom-in" data-aos-delay="100">
                <h1>VALDOOS</h1>
                <p><span class="typed"
                        data-typed-items="Find your new Friend, Free Chat, Choose a location according to your wishes, Lets do it!!"></span>
                </p>
        ...
        <main id="main">
            ...
            <section id="about" class="about">
                <div class="container" data-aos="fade-up">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <img src="{{ asset('img/touch-icon.png') }}" class="img-fluid" alt="">
                        </div>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-item">
                                    ...
                                    <h4>Ceo &amp; Developer</h4>
                                    <p>
                                        <i class="bx bxs-quote-alt-left quote-icon-left"></i> Dari sini saya mendapatkan
                                        banyak relasi sekaligus istri saya sendiri. Terimakasih banyak untuk saya sendiri
                                        selaku developer dari aplikasi ini.
                        ...
                        <div class="col-lg-4">
                            <div class="info">
                                <div class="address">
                                    ...
                                    <h4>Location:</h4>
                                    <p>Jl. Raya Mastrip No.14, Warugunung, Surabaya 60221</p>
                                </div>

                                <div class="email">
                                    <i class="bi bi-envelope"></i>
                                    <h4>Email:</h4>
                                    <p>rivaldomrtd@gmail.com</p>
                                </div>

                                <div class="phone">
                                    <i class="bi bi-phone"></i>
                                    <h4>Call:</h4>
                                    <p>+62 8956 0588 2133</p>
                                </div>
        ...
        <footer id="footer">
            <div class="container">
                <h3>Rivaldo Marta Dinata</h3>
                <p>An application that I made to be able to communicate with people in a certain area</p>
                <div class="social-links">
                    <a href="#" class="twitter"><i class="bx bxl-twitter"></i></a>
                    <a href="#" class="facebook"><i class="bx bxl-facebook"></i></a>
                    <a href="#" class="instagram"><i class="bx bxl-instagram"></i></a>
                ...
                <div class="copyright">
                    &copy; Copyright <strong><span>VALD00s</span></strong>. All Rights Reserved
                </div>
                <div class="credits">
                    ...
                    Designed by <a href="https://bootstrapmade.com/">rivaldomartadinata</a>
                </div>
            </div>
        </footer>
        <!-- End Footer -->
        ...
        <!-- Vendor JS Files -->
        <script type="text/javascript" src="{{ URL::asset('vendor/purecounter/purecounter.js') }}"></script>
        ...
        <script type="text/javascript" src="{{ URL::asset('vendor/typed.js/typed.min.js') }}"></script>
        <script type="text/javascript" src="{{ URL::asset('vendor/waypoints/noframework.waypoints.js') }}"></script>
